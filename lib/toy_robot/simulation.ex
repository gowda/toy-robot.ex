defmodule ToyRobot.Simulation do
  ...
  @doc """
  Moves the robot forward one space in the direction that it is facing, unless that position
  is past the boundaries of the table.
  ...
  def move(%Simulation{robot: robot, table: table} = simulation) do
    with moved_robot <- robot |> Robot.move, true <- table |> Table.valid_position?(moved_robot) do
